...
rectangles it touches to white.
"""
...
def erase_objects(canvas, eraser):
    ...
    # Find all objects overlapping the eraser
    overlapping_objects = canvas.find_overlapping(left_x, top_y, right_x, bottom_y)

    # Change the color of overlapping objects (except the eraser itself) to white
...
def main():
    ...
    # Move the eraser and erase cells as it moves
    while True:
        mouse_x = canvas.get_mouse_x()
        mouse_y = canvas.get_mouse_y()
